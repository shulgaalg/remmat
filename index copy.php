...
<body>
  ...
  <div class="bg-white">
    <header>
      <div class="relative bg-white mb-5 bg-gradient-to-b from-cyan-500 ">
        <div class="mx-auto flex max-w-7xl items-center justify-between   sm:px-6 md:justify-start md:space-x-10 lg:px-8 md:text-xl">
          <div class="flex lg:flex-auto  max-w-6 sm:max-h-6">
            <a href="#">
              <span class="sr-only">Your Company</span>
              <img class="max-h-8 md:max-h-12" src="src/logo.png" alt="">
            </a>
          </div>
          <div>
            <div class="grow mr-4 flex justify-center content-center text-sm lg:text-xl">
              <div class="text-cyan-300 flex content-center grid">
                <span>
              ...
              <div class="p-2 flex">
                ...
                <button class="text-cyan-300 ">// Заказать звонок</button>

              </div>
              <div class=" flex content-center grid">

                <span class="telephone  text-cyan-300 ">
            ...
            <nav class="hidden space-x-10 md:flex group" x-data="Components.popoverGroup()" x-init="init()">
              <div class="relative" x-data="Components.popover({ open: false, focus: false })" x-init="init()" @keydown.escape="onEscape" @close-popover-group.window="onClosePopoverGroup">
                <button type="button" x-state:on="Item active" x-state:off="Item inactive" class="text-gray-500 group inline-flex items-center rounded-md bg-white text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" :class="{ 'text-gray-900': open, 'text-gray-500': !(open) }" @click="toggle" @mousedown="if (open) $event.preventDefault()" aria-expanded="false" :aria-expanded="open.toString()">
                  <span>Решения</span>
              ...
              <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">Продукция</a>
              <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">Отзывы</a>
              <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">О Нас</a>
              <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">Карта</a>
          ...
          <div class="flex flex-auto justify-end">
            ...
            <a href="https://tinyurl.com/354mw3sh"> <img class=" max-h-7 " src="/src/tele.png" />
            </a>
            <a href="https://tinyurl.com/t4du2pyw"> <img class=" max-h-7 " src="/src/viber.png" />
            </a>
          </div>
          ...
          <div class="-my-2 -mr-2 md:hidden  " x-data="{ open: false }">
            <button type="button" class="inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" @click="open = ! open">
              ...
              <svg class="h-7 w-7" x-description="Heroicon name: outline/bars-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5"></path>
              </svg>
            </button>
            <div x-show="open" class="max-w-[65%] absolute left-100 inset-x-0 top-0 z-30 origin-top-right transform p-2 transition md:hidden" x-ref="panel" @click.away="open = false">
    ...
    <main class="">
      <div class="lg:p-2 absolute top-30 z-30 w-full flex justify-center grid justify-items-center">
        <div class="">
          <h1 class="text-center   font-bold tracking-tight mic:text-base sm:text-2xl md:text-4xl lg:text-5xl  mt-10  text-white">
        ...
        <br><br><br>
        <br><br><br>
        <div class="text-2xl font-bold   text-xl text-indigo-100 sm:max-w-3xl ">
          <h2 class="pl-[110px] text-left">
            <ul>
        ...
        <br><br>
        <div class="text-xl text-white   text-center font-bold w-8/12 bg-indigo-500 rounded-md opacity-90">
          ...
          <form method="POST" id="form" action="/application.php" class="text-center text-blue-600" onsubmit="javascript:return validate('form','email');">
            ...
            <input class="w-2/3 rounded h-8 mb-4" type="text" name="InputNameField" id="InputNameField" placeholder="Введите Ваше Имя*" required />
