...
<head>
  ...
  <script src="/dist/placeholder.js"></script>
...
<body>
  ...
  <div class="conteiner">
        ...
        <div class="zaglavie">
          ...
          <div class="grow mr-1 sm:mr-4bg-purple-300 flex justify-center content-center font-semibold text-[#4b0082]"> 
            <!--<div class="text-[#00c3f1] flex content-center grid">-->
              ...
              <span>
                <a href="https://geleon.ua/" target="_blank">// В магазин
                </a>
              </span>
            </div>
            <!--<div class="p-1 sm:p-2 flex">-->
                 <div class="p-1 sm:p-2 flex">
              <script data-b24-form="click/45/yn0kw8" data-skip-moving="true">
                (function(w, d, u) {
            ...
            <div class=" flex content-center grid">
              ...
              <span class="">
                <a href="tel:0996811324" onClick="ga('send', 'event', 'Perezvon', 'Zvonok'); yaCounter49714474.reachGoal('step0:perezvon'); return true;">// (099) 681 13 24
                </a>
              </span>
            </div>
          ...
          <div class="mx-auto flex  items-center justify-between bg-gradient-to-r from-purple-600 to-indigo-600 bg-origin-border px-4 py-2 text-base font-medium text-white shadow-sm hover:from-purple-700 hover:to-indigo-700">
            <div class="w-1/5 sm:flex ">
              <a href="#">
                ...
                <a  href="#" class="logo"><b>Geleon.ua</a>
              </a>
              <a href="#">
            ...
            <div class="">
              <div class="grow mr-1 sm:mr-4 flex justify-center content-center font-semibold
                text-[6px] mic2:text-[8px]  sm:text-xs md:text-xl  lg:text-2xl xl:text-2xl">
              ...
              <nav class="hidden space-x-10 md:flex group text-lg lg:text-xl ">
                ...
                <a href="#prod" class=" text-white text-xl	line-height: 2.5rem;">Продукція</a>
                <a href="#pro" class=" text-white text-xl	line-height: 2.5rem;">Про Нас</a>
                ...
                <div class="flex flex-auto justify-end mic:mx-2 md:mx-4 lg:ml-20 md:mt-2">
                  ...
                  <a href="https://tinyurl.com/t4du2pyw"> <img class="max-h-5 mic:max-h-7 " src="/src/viber.png" />
                  </a>
                </div>
              </nav>
            ...
            <div class="-my-2 -mr-1 sm:-mr-2 md:hidden fixed right-0 top-0 max-md:top-1 z-90" x-data="{ open: false }">
              <button type="button" class=" inline-flex items-center justify-center rounded-md bg-white mic2:p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" @click="open = ! open">
                <span class="sr-only">Open menu</span>
                <svg class=" h-5 w-5 mic:h-6 mic:w-6 sm:h-7 sm:w-7" x-description="Heroicon name: outline/bars-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5"></path>
                </svg>
              </button>
              <div x-show="open" class="max-w-[65%] absolute right-100 top-0 right-0 z-30 origin-top-right transform p-2 transition md:hidden" x-ref="panel" @click.away="open = false">
                <div class="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                  <div class="px-5 pt-5 pb-6 ">
                    <div class="flex items-center justify-between">
                      ...
                      <div class="-mr-2">
                        <button type="button" class="inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" @click="open = false">
                    ...
                    <div class="mt-6">
                      <nav class="grid grid-cols-1 gap-7">
                        ...
                        <a href="#" class="-m-3 flex items-center rounded-lg p-3 hover:bg-gray-50">
                          <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-md bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
                            <svg class="h-6 w-6" x-description="Heroicon name: outline/chat-bubble-bottom-center-text" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                        ...
                        <a href="#" class="-m-3 flex items-center rounded-lg p-3 hover:bg-gray-50">
                          <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-md bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
                            <svg class="h-6 w-6" x-description="Heroicon name: outline/chat-bubble-left-right" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
      ...
      <main class="relative">
        ...
        <div class="lg:p-2 absolute top-6 lg:top-20 z-30 flex  grid justify-items-center  inset-x-0">
          ...
          <!--<div class="mt-2 lg:mt-20 font-bold  text-[8px] lg:text-xl text-indigo-100 sm:max-w-3xl ">
            <h2 class="pl-[20px] lg:pl-[110px] text-left">
              <ul>
                ...
                <li>собственный импорт и свой склад</li>
          ...
          <div class="mt-1 text-[7px] lg:text-xl text-white   text-center font-bold w-8/12   rounded-md border border-transparent bg-gradient-to-r from-purple-600 to-indigo-600 bg-origin-border px-4 py-2 text-base font-medium text-white shadow-sm hover:from-purple-700 hover:to-indigo-700 ">
            ...
            <form method="POST" id="form" action="/application.php" class="text-center text-blue-600" onsubmit="javascript:return validate('form','email');">
        ...
        <div class="one_screen">
         <img class="one_screen-img" src="/img/17.jpg" alt="fon">
        </div>
      ...
      <div class="relative">
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div class="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
            <div class="absolute inset-0">
              <img class="h-full w-full object-cover opacity-30" src="temp/tire_changer_1.jpg" alt="People working on laptops">
              <div class="absolute inset-0 bg-gradient-to-r from-purple-200 to-indigo-700 mix-blend-multiply"></div>
            </div>
            <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
              <h1 class="text-center text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
                <span class="block text-white">Расходные материалы для шиномонтажа</span>
              </h1>
              <h2 class="text-2xl">
                <span class="block text-indigo-200">от латки до комплекта "на первый раз" за 1 звонок</span>
              ...
              <form method="POST" id="form" action="/application.php" onsubmit="javascript:return validate('form','email');">
                ...
                <input onclick="gtag('event', 'newsletter_submit', { 'event_category': 'form_zayvka', 'event_action': 'submit', });" class="btn bg-yellow-400" id="submit" type="submit" value="👉Напишите нам💪" />
              </form>
              <p class="mx-auto mt-6 max-w-lg text-center text-xl text-indigo-200 sm:max-w-3xl"> Отправка каждый день при заказе до 14-00</p>
          ...
          <div class="mx-auto max-w-7xl py-16 px-4 sm:px-6 lg:px-8">
            ...
            <div class="brends">
              <div class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                <img class="brend_logo" src="/img/1.png" alt="TipTop">
              </div>
              <div class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                <img class="brend_logo" src="img/2.png " alt="Mirage">
              </div>
              <div class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                <img class="brend_logo" src="img/3.png" alt="StaticKit">
              </div>
              <div class="col-span-1 flex justify-center md:col-span-2 md:col-start-2 lg:col-span-1">
                <img class="brend_logo" src="img/4.png" alt="Transistor">
              </div>
              <div class="col-span-2 flex justify-center md:col-span-2 md:col-start-4 lg:col-span-1">
                <img class="brend_logo" src="img/5.png" alt="Workcation">
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
              <div class="mx-auto max-w-xl px-4 sm:px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:py-32 lg:px-0">
                <div>
                  <div>
                    <span class="flex h-12 w-12 items-center justify-center rounded-md bg-gradient-to-r from-purple-600 to-indigo-600">
                      <svg class="h-6 w-6 text-white" x-description="Heroicon name: outline/sparkles" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
        ...
        <div class="bg-gradient-to-r from-purple-800 to-indigo-700">
          <div class="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:px-8 lg:pt-24">
            <h2 id="prod" class="text-4xl font-bold tracking-tight text-white">Ассортимент ПРОДУКЦІЇ</h2>
        ...
        <div class="relative bg-gray-900">
          <div class="absolute inset-x-0 bottom-0 h-80 xl:top-0 xl:h-full">
            <div class="h-full w-full xl:grid xl:grid-cols-2">
              <div class="h-full xl:relative xl:col-start-2">
                <img class="h-full w-full object-cover opacity-25 xl:absolute xl:inset-0" src="img/10.png" alt="People working on laptops">
          ...
          <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-flow-col-dense xl:grid-cols-2 xl:gap-x-8">
            <div class="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
              ...
              <p id="pro" class="mt-3 text-3xl font-bold tracking-tight text-white">GELEON.UA <br> НАДІЙНИЙ ПОСТАЧАЛЬНИК ШИНОМОНТАЖНИХ МАТЕРІАЛІВ</p>
	...
	<section id="stepbrend" style="background: №ffffff;">
		<div class="uk-grid-collapse" uk-grid>
			<div class="uk-padding-tovari uk-width-1-1@m">
				<div class="uk-section uk-padding-remove">
					<div class="moduletable uk-center color-black">
            <center>
						<h3 class="otziv" >Отзывы наших клиентов</h3> 
						<iframe width="560" height="315" src="https://www.youtube.com/embed/xnOrp3hBed4?rel=0&amp;controls=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen class="video"></iframe>
						<iframe width="560" height="315" src="https://www.youtube.com/embed/Py8uvlaObVg?rel=0&amp;controls=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen class="video"></iframe>
						<iframe width="560" height="315" src="https://www.youtube.com/embed/5PaxpDER0Gw?rel=0&amp;controls=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen class="video"></iframe>
					   </center>
            </div>
				</div>
			</div>
	...
	<sectioncontact class="contact">
		<h3 class="title">Адреса і контакти:</h3>
		<p>м. Дніпро, вул. Будівельників, 23</p>
    <p> тел:0996699668, 0676699668</p>
		
		<br>
		<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2647.6708525095887!2d35.00120382012425!3d48.42446308271231!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40dbe4a743786765%3A0xba68d71e584ecc94!2z0YPQuy4g0KHRgtGA0L7QuNGC0LXQu9C10LksIDIzLCDQlNC90LjQv9GA0L4sINCU0L3QtdC_0YDQvtC_0LXRgtGA0L7QstGB0LrQsNGPINC-0LHQu9Cw0YHRgtGMLCA0OTAwMA!5e0!3m2!1sru!2sua!4v1533641298974" width="100%" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
	</section>
        ...
        <div class="mx-auto max-w-7xl px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-24">
          ...
          <div class="mt-12 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between lg:mt-16">
            ...
            <p class="mt-8 text-base text-gray-400 md:order-1 md:mt-0">© 2020 Your Company, Inc. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
